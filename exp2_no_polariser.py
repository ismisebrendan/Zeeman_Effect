...
# Plot data and peaks
plot_peaks(pixels, intensity5, peakslmid, pixelslmid, peaksrmid, pixelsrmid, 42)
plot_peaks_no_labels(pixels, intensity5, peakslin, pixelslin, peaksrin, pixelsrin, 18)
plot_peaks_no_labels(pixels, intensity5, peakslout, pixelslout, peaksrout, pixelsrout, 30)
...
# Fit peaks
peakl1mid, pixelsl1mid, errorsl1mid = peak_fitting(intensity6, 868, 889, 880)
peakl2mid, pixelsl2mid, errorsl2mid = peak_fitting(intensity6, 793, 808, 800)
peakl3mid, pixelsl3mid, errorsl3mid = peak_fitting(intensity6, 739, 750, 745)
peakl4mid, pixelsl4mid, errorsl4mid = peak_fitting(intensity6, 693, 705, 700)
peakl5mid, pixelsl5mid, errorsl5mid = peak_fitting(intensity6, 651, 664, 660)
peakl6mid, pixelsl6mid, errorsl6mid = peak_fitting(intensity6, 615, 627, 620)

peakr1mid, pixelsr1mid, errorsr1mid = peak_fitting(intensity6, 1135, 1167, 1150)
peakr2mid, pixelsr2mid, errorsr2mid = peak_fitting(intensity6, 1217, 1244, 1230)
peakr3mid, pixelsr3mid, errorsr3mid = peak_fitting(intensity6, 1279, 1298, 1290)
peakr4mid, pixelsr4mid, errorsr4mid = peak_fitting(intensity6, 1325, 1342, 1330)
peakr5mid, pixelsr5mid, errorsr5mid = peak_fitting(intensity6, 1368, 1379, 1375)
peakr6mid, pixelsr6mid, errorsr6mid = peak_fitting(intensity6, 1407, 1416, 1410)

peakl1in, pixelsl1in, errorsl1in = peak_fitting(intensity6, 892, 929, 895)
peakl1out, pixelsl1out, errorsl1out = peak_fitting(intensity6, 850, 864, 860)
peakl2in, pixelsl2in, errorsl2in = peak_fitting(intensity6, 813, 832, 815)
peakl2out, pixelsl2out, errorsl2out = peak_fitting(intensity6, 782, 796, 790)
peakl3in, pixelsl3in, errorsl3in = peak_fitting(intensity6, 755, 769, 755)
peakl3out, pixelsl3out, errorsl3out = peak_fitting(intensity6, 728, 740, 735)
peakl4in, pixelsl4in, errorsl4in = peak_fitting(intensity6, 705, 716, 705)
peakl4out, pixelsl4out, errorsl4out = peak_fitting(intensity6, 683, 693, 690)
peakl5in, pixelsl5in, errorsl5in = peak_fitting(intensity6, 662, 674, 665)
peakl5out, pixelsl5out, errorsl5out = peak_fitting(intensity6, 644, 652, 650)
peakl6in, pixelsl6in, errorsl6in = peak_fitting(intensity6, 626, 635, 630)
peakl6out, pixelsl6out, errorsl6out = peak_fitting(intensity6, 607, 614, 614)

peakr1in, pixelsr1in, errorsr1in = peak_fitting(intensity6, 1113, 1135, 1130)
peakr1out, pixelsr1out, errorsr1out = peak_fitting(intensity6, 1167, 1187, 1170)
peakr2in, pixelsr2in, errorsr2in = peak_fitting(intensity6, 1202, 1218, 1215)
peakr2out, pixelsr2out, errorsr2out = peak_fitting(intensity6, 1239, 1252, 1240)
peakr3in, pixelsr3in, errorsr3in = peak_fitting(intensity6, 1265, 1279, 1275)
peakr3out, pixelsr3out, errorsr3out = peak_fitting(intensity6, 1294, 1308, 1295)
peakr4in, pixelsr4in, errorsr4in = peak_fitting(intensity6, 1313, 1328, 1325)
peakr4out, pixelsr4out, errorsr4out = peak_fitting(intensity6, 1340, 1353, 1345)
peakr5in, pixelsr5in, errorsr5in = peak_fitting(intensity6, 1355, 1369, 1365)
peakr5out, pixelsr5out, errorsr5out = peak_fitting(intensity6, 1382, 1391, 1385)
peakr6in, pixelsr6in, errorsr6in = peak_fitting(intensity6, 1395, 1405, 1405)
peakr6out, pixelsr6out, errorsr6out = peak_fitting(intensity6, 1419, 1427, 1420)
...
# Plot data and peaks
plot_peaks(pixels, intensity6, peakslmid, pixelslmid, peaksrmid, pixelsrmid, 42)
plot_peaks_no_labels(pixels, intensity6, peakslin, pixelslin, peaksrin, pixelsrin, 18)
plot_peaks_no_labels(pixels, intensity6, peakslout, pixelslout, peaksrout, pixelsrout, 30)
...
peakl1in, pixelsl1in, errorsl1in = peak_fitting(intensity7, 892, 914, 895)
peakl1out, pixelsl1out, errorsl1out = peak_fitting(intensity7, 849, 860, 855)
peakl2in, pixelsl2in, errorsl2in = peak_fitting(intensity7, 814, 829, 815)
peakl2out, pixelsl2out, errorsl2out = peak_fitting(intensity7, 779, 795, 790)
peakl3in, pixelsl3in, errorsl3in = peak_fitting(intensity7, 753, 764, 755)
peakl3out, pixelsl3out, errorsl3out = peak_fitting(intensity7, 726, 738, 735)
peakl4in, pixelsl4in, errorsl4in = peak_fitting(intensity7, 705, 715, 705)
peakl4out, pixelsl4out, errorsl4out = peak_fitting(intensity7, 682, 692, 690)
peakl5in, pixelsl5in, errorsl5in = peak_fitting(intensity7, 663, 676, 665)
peakl5out, pixelsl5out, errorsl5out = peak_fitting(intensity7, 641, 652, 650)
peakl6in, pixelsl6in, errorsl6in = peak_fitting(intensity7, 626, 637, 630)
peakl6out, pixelsl6out, errorsl6out = peak_fitting(intensity7, 603, 615, 614)

peakr1in, pixelsr1in, errorsr1in = peak_fitting(intensity7, 1113, 1137, 1130)
peakr1out, pixelsr1out, errorsr1out = peak_fitting(intensity7, 1169, 1193, 1175)
peakr2in, pixelsr2in, errorsr2in = peak_fitting(intensity7, 1205, 1218, 1215)
peakr2out, pixelsr2out, errorsr2out = peak_fitting(intensity7, 1242, 1253, 1245)
peakr3in, pixelsr3in, errorsr3in = peak_fitting(intensity7, 1266, 1279, 1275)
peakr3out, pixelsr3out, errorsr3out = peak_fitting(intensity7, 1295, 1307, 1300)
peakr4in, pixelsr4in, errorsr4in = peak_fitting(intensity7, 1316, 1326, 1325)
peakr4out, pixelsr4out, errorsr4out = peak_fitting(intensity7, 1343, 1353, 1345)
peakr5in, pixelsr5in, errorsr5in = peak_fitting(intensity7, 1358, 1369, 1365)
peakr5out, pixelsr5out, errorsr5out = peak_fitting(intensity7, 1383, 1391, 1385)
peakr6in, pixelsr6in, errorsr6in = peak_fitting(intensity7, 1397, 1407, 1405)
peakr6out, pixelsr6out, errorsr6out = peak_fitting(intensity7, 1419, 1427, 1420)
...
# Plot data and peaks
plot_peaks(pixels, intensity7, peakslmid, pixelslmid, peaksrmid, pixelsrmid, 42)
plot_peaks_no_labels(pixels, intensity7, peakslin, pixelslin, peaksrin, pixelsrin, 18)
plot_peaks_no_labels(pixels, intensity7, peakslout, pixelslout, peaksrout, pixelsrout, 30)
...
# Store the radii, delta radii and rdr and their errors
radii_in_arr = np.append(radii_in_arr, radius_in_arr).reshape((5,6))
delta_radii_in_arr = np.append(delta_radii_in_arr, del_radius_in).reshape((5,6))
rdr_in_arr = np.append(rdr_in_arr, rdr_in).reshape((5,6))

err_radii_in_arr = np.abs(np.append(err_radii_in_arr, error_in_arr).reshape((5,6)))
err_delta_radii_in_arr = np.abs(np.append(err_delta_radii_in_arr, err_del_radius_in).reshape((5,6)))
err_rdr_in_arr = np.abs(np.append(err_rdr_in_arr, err_rdr_in).reshape((5,6)))

radii_out_arr = np.append(radii_out_arr, radius_out_arr).reshape((5,6))
delta_radii_out_arr = np.append(delta_radii_out_arr, del_radius_out).reshape((5,6))
rdr_out_arr = np.append(rdr_out_arr, rdr_out).reshape((5,6))

err_radii_out_arr = np.abs(np.append(err_radii_out_arr, error_out_arr).reshape((5,6)))
err_delta_radii_out_arr = np.abs(np.append(err_delta_radii_out_arr, err_del_radius_out).reshape((5,6)))
err_rdr_out_arr = np.abs(np.append(err_rdr_out_arr, err_rdr_out).reshape((5,6)))

radii_mid_arr = np.append(radii_mid_arr, radius_mid_arr).reshape((5,6))
delta_radii_mid_arr = np.append(delta_radii_mid_arr, del_radius_mid).reshape((5,6))
rdr_mid_arr = np.append(rdr_mid_arr, rdr_mid).reshape((5,6))

err_radii_mid_arr = np.abs(np.append(err_radii_mid_arr, error_mid_arr).reshape((5,6)))
err_delta_radii_mid_arr = np.abs(np.append(err_delta_radii_mid_arr, err_del_radius_mid).reshape((5,6)))
err_rdr_mid_arr = np.abs(np.append(err_rdr_mid_arr, err_rdr_mid).reshape((5,6)))




output_file = open('exp2_no_polariser_output.txt','w')
output_file.write('Middle rings')

for i in range(len(radii_mid_arr)):
    if i == 0:
        output_file.write('Radii,\tDelta r,\tr Delta r \n')
        output_file.write('I = '+str(i)+' A\n')
    else:
        output_file.write('I = '+str(i+3)+' A\n')
    for j in range(len(radii_mid_arr[i])):
        r, err_r = round_sig_fig_uncertainty(radii_mid_arr[i][j], err_radii_mid_arr[i][j])
        dr, err_dr = round_sig_fig_uncertainty(delta_radii_mid_arr[i][j], err_delta_radii_mid_arr[i][j])
        rdr, err_rdr = round_sig_fig_uncertainty(rdr_mid_arr[i][j], err_rdr_mid_arr[i][j])
